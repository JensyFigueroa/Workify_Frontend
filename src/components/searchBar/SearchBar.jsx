...
const SearchBar = () => {
  ...
  const hendleSearch = (event) => {
    ...
    dispatch(getServicesByName(input));
    setInput("");
  };
  ...
  return (
    <>
      <form className={styles.search} onClick={hendleSearch}>
        <div className="input-group">
          <span className={`${styles.inputGroupText} input-group-text`}>
            <button
              type="button"
              className={`${styles.location} dropdown-toggle`}
          ...
          />
          <span className={`${styles.inputGroupText} input-group-text`}>
            <button type="submit" className={styles.location}>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body" onClick={getCurrentLocation}>
                <Link className={styles.linkLocation}>
